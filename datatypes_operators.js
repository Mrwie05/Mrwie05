...
console.log("Addition:", numA + numB);          // 14  
console.log("Subtraction:", numA - numB);       // 6  
console.log("Multiplication:", numA * numB);    // 40  
console.log("Division:", numA / numB);          // 2.5  
console.log("Modulus:", numA % numB);           // 2  
console.log("Exponentiation:", numA ** numB);   // 10^4 = 10000  
